...
- Run ID: `2026-04-30T06-38-27-738Z`
- 配置文件: `/Users/qinyang/Desktop/GraduationProjectQY/bigtest/config.local.json`
- 输出目录: `output/2026-04-30T06-38-27-738Z`
- 自动探索: 已开启
- 安全写操作: 已开启，测试数据前缀 `BIGTEST_2026-04-30T06-38-27-738Z`

## 总览

| Profile | 页面 | 输入 | 按钮 | 原始请求 | 生成用例 | 安全写通过 | 安全写失败 | 回放通过 | 回放失败 | 回放跳过 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| auto-default | 28 | 413/70 | 542/51 | 92 | 37 | 1 | 0 | 34 | 0 | 3 |
...
- 发现路由: 36
- 实际访问页面: 28
- 输入框: 413 个，已自动填写 70 个
- 按钮/链接: 542 个，安全点击 51 个
- 自动取消确认弹窗: 0
- API 资源数: 10
- 安全拦截/跳过: 343
...
| auto-default-4 | GET | `/api/v1/stats/dashboard` | 3 | 是 |
| auto-default-5 | GET | `/api/v1/messages/unread-count` | 24 | 是 |
...
| auto-default-28 | PUT | `/api/v1/messages/39/read` | 1 | 是 |
| auto-default-29 | PUT | `/api/v1/messages/36/read` | 1 | 是 |
| auto-default-30 | GET | `/api/v1/jobs?page=1&page_size=10&search=%E5%90%8E%E7%AB%AF` | 1 | 是 |
| auto-default-31 | GET | `/api/v1/logs?page=1&page_size=20` | 2 | 是 |
| auto-default-32 | GET | `/api/v1/logs?end_time=2026-05-01&keyword=%E6%B5%8B%E8%AF%95&page=1&page_size=20&start_time=2026-05-01` | 1 | 是 |
| auto-default-33 | GET | `/api/v1/notices/1` | 2 | 是 |
| auto-default-34 | GET | `/api/v1/notices?page=1&page_size=10` | 3 | 是 |
| auto-default-35 | GET | `/api/v1/notices/20` | 1 | 是 |
| auto-default-36 | GET | `/api/v1/notices?keyword=%E6%A0%A1%E5%9B%AD%E6%8B%9B%E8%81%98&page=1&page_size=10` | 1 | 是 |
| auto-default-37 | GET | `/api/v1/notices/11` | 1 | 是 |
...
| auto-default-28 | SKIP | - | - | PUT/DELETE target is not registered BIGTEST data |
| auto-default-29 | SKIP | - | - | PUT/DELETE target is not registered BIGTEST data |
...
| auto-default-36 | PASS | 200 | 200 | ok |
| auto-default-37 | PASS | 200 | 200 | ok |
