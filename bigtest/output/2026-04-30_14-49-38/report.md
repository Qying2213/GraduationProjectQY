...
- Run ID: `2026-04-30_14-49-38`
- 配置文件: `/Users/qinyang/Desktop/GraduationProjectQY/bigtest/config.local.json`
- 输出目录: `output/2026-04-30_14-49-38`
- 自动探索: 已开启
- 安全写操作: 已开启，测试数据前缀 `BIGTEST_2026-04-30_14-49-38`
...
| --- | --- | --- | --- | --- | ---: | --- |
| notice-crud-owned-data | create | POST | `/api/v1/notices` | 200, 201 | 200 | PASS |
| notice-crud-owned-data | verify | GET | `/api/v1/notices/27` | 200 | 200 | PASS |
| notice-crud-owned-data | update | PUT | `/api/v1/notices/27` | 200 | 200 | PASS |
| notice-crud-owned-data | cleanup | DELETE | `/api/v1/notices/27` | 200, 204 | 200 | PASS |
...
| auto-default-26 | GET | `/api/v1/interviews/1` | 1 | 是 |
| auto-default-27 | GET | `/api/v1/interviews/1/feedback` | 1 | 是 |
