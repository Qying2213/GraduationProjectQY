...
- Run ID: `2026-04-30T04-01-58-070Z`
- 配置文件: `/Users/qinyang/Desktop/GraduationProjectQY/bigtest/config.local.json`
- 输出目录: `output/2026-04-30T04-01-58-070Z`
- 自动探索: 已开启
- 安全写操作: 已开启，测试数据前缀 `BIGTEST_2026-04-30T04-01-58-070Z`

## 总览

| Profile | 页面 | 输入 | 按钮 | 原始请求 | 生成用例 | 安全写通过 | 安全写失败 | 回放通过 | 回放失败 | 回放跳过 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| auto-default | 28 | 115/19 | 542/43 | 88 | 33 | 1 | 0 | 32 | 0 | 1 |
...
- 发现路由: 36
- 实际访问页面: 28
- 输入框: 115 个，已自动填写 19 个
- 按钮/链接: 542 个，安全点击 43 个
- 自动取消确认弹窗: 0
- API 资源数: 10
- 安全拦截/跳过: 336
...
| unknown | a
admin | `http://localhost:5173/portal` |
...
| unknown | a
admin | `http://localhost:5173/portal/jobs` |
...
| unknown | a
admin | `http://localhost:5173/portal/jobs/1` |
...
| auto-default-18 | GET | `/api/v1/talents?page=1&page_size=10` | 2 | 是 |
| auto-default-19 | GET | `/api/v1/talents?page=1&page_size=10&search=%E6%B5%8B%E8%AF%95` | 1 | 是 |
| auto-default-20 | GET | `/api/v1/jobs?page=1&page_size=10` | 5 | 是 |
| auto-default-21 | GET | `/api/v1/jobs?page=1&page_size=10&search=%E5%90%8E%E7%AB%AF` | 1 | 是 |
| auto-default-22 | GET | `/api/v1/jobs/1/applications?page=1&page_size=10` | 1 | 是 |
| auto-default-23 | GET | `/api/v1/jobs?page_size=100&status=open` | 1 | 是 |
| auto-default-24 | GET | `/api/v1/resumes?page=1&page_size=10` | 2 | 是 |
| auto-default-25 | GET | `/api/v1/resumes?page=1&page_size=10&search=%E6%B5%8B%E8%AF%95` | 1 | 是 |
| auto-default-26 | GET | `/api/v1/jobs?page=1&page_size=20` | 1 | 是 |
| auto-default-27 | GET | `/api/v1/applications?page=1&page_size=50` | 1 | 是 |
| auto-default-28 | GET | `/api/v1/interviews/1` | 1 | 是 |
| auto-default-29 | GET | `/api/v1/interviews/1/feedback` | 1 | 是 |
| auto-default-30 | GET | `/api/v1/logs?page=1&page_size=20` | 2 | 是 |
| auto-default-31 | GET | `/api/v1/notices/1` | 2 | 是 |
| auto-default-32 | GET | `/api/v1/notices?page=1&page_size=10` | 3 | 是 |
| auto-default-33 | GET | `/api/v1/notices?keyword=%E6%A0%A1%E5%9B%AD%E6%8B%9B%E8%81%98&page=1&page_size=10` | 1 | 是 |
