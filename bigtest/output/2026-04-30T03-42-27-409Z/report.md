...
- Run ID: `2026-04-30T03-42-27-409Z`
- 配置文件: `/Users/qinyang/Desktop/GraduationProjectQY/bigtest/config.local.json`
- 输出目录: `output/2026-04-30T03-42-27-409Z`
- 自动探索: 已开启
- 安全写操作: 已开启，测试数据前缀 `BIGTEST_2026-04-30T03-42-27-409Z`

## 总览

| Profile | 原始请求 | 生成用例 | 安全写通过 | 安全写失败 | 回放通过 | 回放失败 | 回放跳过 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| admin-smoke | 106 | 33 | 1 | 0 | 32 | 0 | 1 |
...
| admin-smoke-3 | GET | `/api/v1/talents?page=1&page_size=20` | 4 | 是 |
| admin-smoke-4 | GET | `/api/v1/messages?page=1&page_size=5` | 4 | 是 |
| admin-smoke-5 | GET | `/api/v1/messages/unread-count` | 28 | 是 |
...
| admin-smoke-31 | GET | `/api/v1/interviews/1` | 1 | 是 |
| admin-smoke-32 | GET | `/api/v1/interviews/1/feedback` | 1 | 是 |
