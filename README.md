...
<p align="center">
  <strong>🚀 基于 Go 微服务架构 + Vue3 + Coze AI 的毕业设计项目</strong>
</p>
...
智能人才运营平台是一个面向招聘业务全流程的毕业设计项目，采用**微服务架构**设计，包含**企业管理后台**、**求职者门户**和**数据大屏**三大模块。
...
| 维度 | 当前结果 | 证据 |
|------|----------|------|
| 毕业设计专项验收 | 34/34 检查项通过 | [专项验收报告](ztest/graduation_acceptance_report_20260401_115415.md) |
| 全链路接口测试 | 33/33 接口通过 | [全链路测试报告](ztest/test_report_20260401_112429.md) |
| 性能目标 | 核心读接口 QPS 均超过 1000，平均延迟远低于 300ms | [交付验收报告](docs/毕业设计交付验收报告_20260401.md) |
| 详细测试记录 | 已整理为论文/答辩可引用的正式测试材料 | [详细测试报告](docs/毕业设计详细测试报告_20260401.md) |

说明：

- 当前交付与答辩范围 **不包含论坛模块**。
- AI 评估链路当前采用 `OCR -> Embedding -> RAG -> Coze 工作流` 的组合方案。
...
| 功能 | 描述 |
|------|------|
| 📊 **智能评估** | 基于 `OCR + Embedding + RAG + Coze` 的多维度简历评分（技术能力/项目经验/教育背景/JD匹配度） |
...
| 全链路接口测试 | 33/33 通过 |
| 毕业设计专项验收 | 34/34 通过 |
| 核心读接口压测 | `/jobs` 1379.80 QPS / `/talents` 2941.49 QPS / `/recommendations/stats` 4073.02 QPS |

### 测试材料入口

- [毕业设计交付验收报告](docs/毕业设计交付验收报告_20260401.md)
- [毕业设计详细测试报告](docs/毕业设计详细测试报告_20260401.md)
- [专项验收报告](ztest/graduation_acceptance_report_20260401_115415.md)
- [性能测试报告](benchmark_results/性能测试报告_20260401_112500.md)
...
| 📘 **Swagger/OpenAPI** | 完整接口规格、参数与响应模型 | [查看文档](backend/docs/swagger.yaml) |
...
| 📄 **交付验收报告** | 面向毕业设计交付的综合结论 | [查看文档](docs/毕业设计交付验收报告_20260401.md) |
| 🧾 **详细测试报告** | 更适合论文附件/答辩引用的正式测试记录 | [查看文档](docs/毕业设计详细测试报告_20260401.md) |
...
### 架构设计
- ✅ **微服务架构**：8个业务微服务 + API网关 + AI评估服务，职责清晰，支持独立部署和扩展
...
本项目为大学毕业设计作品 —— **基于微服务架构的智能人才运营平台设计与实现**

### 技术创新点
1. **微服务架构实践**：将单体应用拆分为8个业务微服务 + API网关 + AI评估服务
2. **AI 能力集成**：利用 OCR、Embedding、RAG 与 Coze 工作流实现智能简历评估
